    ...
    <h2 class="text-center p-5">Edit Data</h2>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group pt-3">
                        ...
                        <div class="col-sm-10">
                          <input type="file" class="form-control" id="logoimg" value="<?php echo $pimg1; ?>" name="logoimg" required>
                        </div>
                      </div>
                      <div class="form-group pt-3">
                      ...
                      <div class="form-group pt-3">        
                        ...
                        <button type="submit" name="Update" class="btn btn-default bg-success text-white">Update</button>
                                            </div>
                      </div>
                    </form>
                    </div>
